<?php  decents_blog_set_post_view(); 

$showauthor=get_theme_mod('decents_blog_single_co_post_author',true);
$showdate=get_theme_mod('decents_blog_single_co_post_date',true);
$showimage=get_theme_mod('decents_blog_single_co_featured_image_post',true);
$showcategory=get_theme_mod('decents_blog_single_co_post_category',true);
$showview=get_theme_mod('decents_blog_single_co_post_view',true);
$showtag=get_theme_mod('decents_blog_single_co_post_tags',true);
                ...
                <div class="post-prev">
                    <a href="<?php echo esc_url($previous_post_url); ?>">
                        ...
                        <div class="prev-post-title">
                            <span><?php echo esc_html__('Previous Post','decents-blog'); ?></span>
                ...
                <div class="post-next">
                    <a href="<?php echo esc_url($next_post_url); ?>">
                        ...
                        <div class="next-post-title">
                            <span><?php echo esc_html__('Next Post','decents-blog');?></span>
